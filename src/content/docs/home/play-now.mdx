...
3. Enter the following details:
   ...
   **Server Address:** 
   ```
   join.VistaValley.xyz
   ```

4. You're ready to join the adventure!
</Steps>

:::caution[`Failed to log in: Invalid session`]
...
:::note[Tip]
If you have trouble joining using the server address, you can also join by adding `VistaValleyBE` as a friend on your Microsoft account and then joining through the friends list in Minecraft.
:::
